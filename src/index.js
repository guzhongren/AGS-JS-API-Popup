define([
    ...
    return declare([], {
        ...
        show: function(mapPoint, content, style){
            if(this._tempPopupDom) {
                this.destroy();
            };
            this._createSiglePopup();
            this._content = content;
            let tempPosition = this._view.toScreen(mapPoint);
            this._style= Object.assign(style, {"background-color":"#fff","top": tempPosition.y + 10+"px", "left":  tempPosition.x + 10+"px", "min-width": "300px", "z-index": "888", "position": "absolute", "word-wrap":"break-word"});
